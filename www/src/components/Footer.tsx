    ...
    <footer className="">
      <div className="p-6  mx-auto relative z-10 overflow-hidden border border-b-0">
        <div className="flex flex-col items-center gap-4 text-center">
          <Link href="/">{/* <LogoType className='h-7 text-gray-800' /> */}</Link>
          <p className="max-w-md text-sm text-gray-500">
            A simple idea I had while in Zanzibar, brought to life to solve a problem I
            had.{" "}
          </p>
          <p className="max-w-md text-sm text-gray-500">
          ...
          <p className="text-sm leading-5 text-gray-400">
            © {new Date().getFullYear()} Copy Pasta
          </p>
          <div className="flex items-center space-x-3">
            <a
              href="https://github.com/Faitltd/copy-paste"
              target="_blank"
              rel="noreferrer"
